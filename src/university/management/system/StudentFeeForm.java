    ...
    try {
        ...
        e.printStackTrace();
           ...
           String total = labeltotal.getText();
            ...
            try{
                 sql_server_connection c = new sql_server_connection();  // To Hit the query with mysql we have created a connection with the help of connection class 
                String query = "INSERT INTO collegefee VALUES (CONVERT(varbinary, '" + rollno + "'), CONVERT(varbinary, '" + course + "'), CONVERT(varbinary, '" + branch + "'), CONVERT(varbinary, '" + semester + "'), CONVERT(varbinary, '" + total + "'))";
